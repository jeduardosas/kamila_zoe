    ...
    <>
      ...
      <div className="confirmar-card  sombra">
        <div className="confirmar-border centrar">
          ...
          <button><a target="_blank" href="https://api.whatsapp.com/send?phone=527335826265&text=¡Hola!👋%0AQuiero%20confirmar%20mi%20asistencia%0Aa%20los%20XV%20de%20Kamila%20Zoé%20👑">CONFIRMAR</a></button>
        </div>
      </div>
    </>
  )
